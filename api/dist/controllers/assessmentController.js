...
const getAssessment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const assessment = yield Assessment_1.default.findById(req.params.id)
            .select('title questions subject difficulty');
        if (!assessment) {
...
const submitPractice = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const practiceSession = new PracticeSession_1.default({
            user: req.user._id,
            assessment: assessment._id,
            answers,
            score,
...
const getResults = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const assessment = yield Assessment_1.default.findById(practiceSession.assessment)
